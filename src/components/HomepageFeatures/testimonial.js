...
// Yes, these do mention DocuHub. We'll need to get new testimonials at some point.
// Still, please don't change these inline. Altering quotes from other people is inappropriate,
// even when it's purely to account for a rebrand.
...
export default function ResearcherTestimonials() {
    const testimonials = [
        ...
        },
        {
            name: "James Halgren",
            initial: "JH",
            quote: "Having a community editable common place for sharing code, data resources, and community guidance was one of the critical first steps to being able to gather a community for operational hydrological modeling. CIROH DocuHub has begun to fill that gap. I am excited to see it growing and hope it becomes a valuable resource for the CIROH researchers and broader community.",
            date: "April 2025",
        ...
        },
        {
            name: "Gio",
            initial: "G",
            quote: "What I like the most about using CIROH DocuHub is that it is easy to contribute to the documentation when I update or want to add my research work. Also, I like the idea that I can contribute with blogs and tutorials depending on the needs of the community.",
            date: "April 2025",
        ...
        },
        {
            name: "Quinn Lee",
            initial: "QL",
            quote: "I frequently use CIROH DocuHub to access documentation and best practices for the computing infrastructure I use for my research.",
            date: "April 2025",
        ...
        <section className="researcher-testimonials-section" id="researcher-testimonials">
            <div className="researcher-testimonials-container">
                ...
                <div style={{"textAlign": "center"}}>
                    ...
                    { /* FIXME: We need to just get new testimonials, frankly. (Or explicit permission from the people we quote to update them) */ }
                </div>
